...
export const bookingUrl = "https://api.whatsapp.com/send/?phone=5585992818015&text=Ol%C3%A1%21+Vim+pelo+site+da+Humaniza+Cl%C3%ADnica+e+gostaria+de+agendar+uma+consulta.+Pode+me+ajudar%3F+%EF%BF%BD&type=phone_number&app_absent=0";
  ...
  return <div className="min-h-screen overflow-x-hidden bg-background">
    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-[1.2fr_1fr_1fr] md:px-8 md:py-18">
        ...
        <div><p className="text-xs font-bold uppercase tracking-[0.18em]">Acompanhe</p><a className="mt-4 flex items-center gap-2 text-sm text-primary-foreground/75 hover:text-primary-foreground" href="https://instagram.com/humanizaodontofortaleza" target="_blank" rel="noreferrer"><Instagram className="size-4" /> Instagram</a><a className="mt-3 flex items-center gap-2 text-sm text-primary-foreground/75 hover:text-primary-foreground" href={bookingUrl} target="_blank" rel="noreferrer"><MessageCircle className="size-4" /> WhatsApp</a></div>
      </div>
