...
function Index() {
  ...
  return <>
    ...
    <section className="grid bg-primary md:grid-cols-2"><div className="min-h-[380px] p-5 md:min-h-[620px] md:p-8"><FramedImage src={clinic} alt="Ambiente conceitual de consultório odontológico sofisticado e acolhedor" width={1600} height={1104} loading="lazy" className="size-full" imgClassName="size-full" /></div><div className="flex items-center px-5 py-16 text-primary-foreground md:px-16"><div className="max-w-lg"><p className="text-xs font-bold uppercase tracking-[0.2em] text-primary-foreground/60">Um espaço para respirar</p><h2 className="mt-4 text-4xl leading-tight md:text-6xl">Conforto também faz parte do tratamento.</h2><p className="mt-6 leading-8 text-primary-foreground/75">Cada detalhe é pensado para desacelerar: um ambiente sereno, uma conversa sem pressa e um atendimento que respeita você por inteiro.</p><TextLink to="/sobre">Conheça nossa forma de cuidar</TextLink></div></div></section>
