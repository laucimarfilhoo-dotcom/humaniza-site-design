...
function Index() {
  ...
  return <>
    <section className="relative min-h-[calc(100svh-4.5rem)] bg-cream text-primary md:min-h-[760px]">
      <div className="relative mx-auto flex min-h-[calc(100svh-4.5rem)] max-w-7xl flex-col justify-end px-5 pb-16 pt-28 md:min-h-[760px] md:px-8 md:pb-24">
        <div className="max-w-3xl reveal-up"><p className="mb-5 text-xs font-bold uppercase tracking-[0.22em] text-primary/70">Odontologia gentil em Fortaleza</p><h1 className="text-5xl leading-[0.92] md:text-7xl lg:text-8xl">Seu sorriso cuidado com leveza, gentileza e tempo.</h1><p className="mt-7 max-w-xl text-base leading-7 text-primary/80 md:text-lg">Uma odontologia humanizada que vai além dos procedimentos: começa pela escuta, pelo entendimento da sua história e pelo planejamento de um cuidado que faça sentido para a sua realidade.</p><div className="mt-8 flex flex-wrap gap-3"><Button asChild size="xl"><a href={bookingUrl} target="_blank" rel="noreferrer">Agendar minha consulta <ArrowRight /></a></Button><Button asChild size="xl" variant="outline" className="border-primary/30 bg-cream text-primary hover:bg-primary/10 hover:text-primary"><a href="#conheca">Conhecer a Humaniza <ArrowDown /></a></Button></div></div>
      </div>
    </section>
