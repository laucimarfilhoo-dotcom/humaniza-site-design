...
], links: [{ rel: "canonical", href: "/sobre" }], scripts: [{ type: "application/ld+json", children: JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Início", item: "https://humanizaclinica.vercel.app/" }, { "@type": "ListItem", position: 2, name: "Sobre", item: "https://humanizaclinica.vercel.app/sobre" }] }) }] }), component: Sobre });
const team = [
